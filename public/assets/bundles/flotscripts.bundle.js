!(function (r) {
    (r.color = {}),
        ...
        (r.color.extract = function (e, t) {
            var i;
            do {
                if ("" != (i = e.css(t).toLowerCase()) && "transparent" != i)
                    break;
                e = e.parent();
            } while (e.length && !r.nodeName(e.get(0), "body"));
            return (
                "rgba(0, 0, 0, 0)" == i && (i = "transparent"), r.color.parse(i)
            );
        }),
        (r.color.parse = function (e) {
            ...
            if (
                (t = /#([a-fA-F0-9]{2})([a-fA-F0-9]{2})([a-fA-F0-9]{2})/.exec(
                    e
                ))
            )
                return i(
        ...
        function n(m, e, t, n) {
            ...
            function o(e) {
                (S = (function (e) {
                    ...
                    (function () {
                        ...
                        for (e = 0; e < S.length; ++e)
                            (o = S[e]),
                                W(C.processDatapoints, [o, o.datapoints]);
                        for (e = 0; e < S.length; ++e) {
                            (o = S[e]),
                                (r = o.datapoints.points),
                                (a = o.datapoints.pointsize),
                ...
                (M = d.width - w.left - w.right),
                    ...
                    Q.each(t, function (e, t) {
                        !(function (e) {
                            ...
                            "x" == e.direction
                                ? ((i = e.scale =
                                      M / Math.abs(o(e.max) - o(e.min))),
                                  (n = Math.min(o(e.max), o(e.min))))
                                : ((i = -(i = e.scale =
                                      T / Math.abs(o(e.max) - o(e.min)))),
                        ...
                        Q.each(I(), function (e, t) {
                            var i,
                                ...
                                h =
                                    ...
                                    "flot-tick-label tickLabel";
                            if (
                                (d.removeText(c), t.show && 0 != t.ticks.length)
                            )
                    ...
                    (function () {
                        ...
                        if (z.legend.sorted)
                            if (Q.isFunction(z.legend.sorted))
                                n.sort(z.legend.sorted);
                            ...
                            if (!s || !c)
                                if (
                                    ...
                                    y.beginPath(),
                                        ...
                                        (y.lineWidth = h),
                                        s
                                            ? (y.moveTo(a.to + u, l.from),
                                              y.lineTo(a.to + u, l.to))
                                            : (y.moveTo(a.from, l.to + u),
                                              y.lineTo(a.to, l.to + u)),
                                        y.stroke();
                                } else
                                    (y.fillStyle =
                                        r.color || z.grid.markingsColor),
            ...
            (A.setData = o),
                ...
                (function (e) {
                    ...
                    null == z.grid.borderColor &&
                        (z.grid.borderColor = z.grid.color);
                    ...
                    z.grid.coloredAreas &&
                        (z.grid.markings = z.grid.coloredAreas);
                ...
                (function () {
                    z.grid.hoverable &&
                        (h.mousemove(q), h.bind("mouseleave", O));
            ...
            function H(e, t, i) {
                ...
                var l = (function (e, t, i) {
                    ...
                    return s
                        ? ((n = s[0]),
                          ...
                          {
                              datapoint: S[n].datapoints.points.slice(
                                  o * r,
                                  (o + 1) * r
                              ),
                              dataIndex: o,
                ...
                if (
                    (l &&
                        ((l.pageX = parseInt(
                            l.series.xaxis.p2c(l.datapoint[0]) +
                                n.left +
                                w.left,
                            10
                        )),
            ...
            function Y(e, t, i) {
                if (
                    ("number" == typeof e && (e = S[e]), "number" == typeof t)
                ) {
                ...
                return (
                    null == t &&
                        (null == this.textContainer &&
                            (this.textContainer = Q(
                                "<div class='flot-text'></div>"
                            )
                                .css({
                                    position: "absolute",
                                    top: 0,
        ...
        (u[g] = 200),
            ...
            (a.event.special[d] = {
                ...
                teardown: function () {
                    ...
                    e.removeData(p),
                        h.length ||
                            (f ? cancelAnimationFrame(c) : clearTimeout(c),
                            (c = null));
                },
                add: function (e) {
                    if (!u[o] && this[i]) return !1;
            ...
            init: function (h) {
                ...
                function t(e, t) {
                    var i,
                        ...
                        a = (function (e, t) {
                            ...
                            parseInt(t.pageX - r.left),
                            parseInt(t.pageY - r.top)
                        );
                ...
                h.hooks.processOptions.push(function (e, t) {
                    ...
                    h.hooks.bindEvents.push(function (e, t) {
                        ...
                        i.series.pie.show &&
                            (i.grid.hoverable &&
                                t.unbind("mousemove").mousemove(n),
                            ...
                            (function (e, t) {
                                if (v) {
                                    ...
                                    (f = t),
                                        (s = !1),
                                        (u =
                                            Math.min(m, x / b.series.pie.tilt) /
                                            2),
                                ...
                                function l() {
                                    ...
                                    for (var r = n, e = 0; e < a.length; ++e)
                                        (a[e].startAngle = r),
                                            t(a[e].angle, a[e].color, !0);
                                    if (
                                        (f.restore(),
                                        0 < b.series.pie.stroke.width)
                                    ) {
                                        f.save(),
                                            (f.lineWidth =
                                                b.series.pie.stroke.width),
                                            (r = n);
                                        for (var e = 0; e < a.length; ++e)
                                            t(
                                                a[e].angle,
                                                b.series.pie.stroke.color,
                                                !1
                                            );
                                        f.restore();
                                    }
                ...
                if (!a) {
                    ...
                    if (
                        ...
                        a.push({
                            ...
                            l.bars.horizontal &&
                                (delete a[a.length - 1].y,
                                (a[a.length - 1].x = !0));
                    }
                    n.format = a;
                }
                for (var c = 0; c < a.length; ++c)
                    a[c].x && o && (a[c].number = !1),
                        a[c].y && r && (a[c].number = !1);
            }
        }
        function s(e) {
            var t = [];
        ...
        l.plot.plugins.push({
            init: function (e) {
                e.hooks.processRawData.push(t),
                    e.hooks.processDatapoints.push(i);
            },
            options: {
                        ...
                        "time" == x.mode &&
                            ((t.tickGenerator = function (e) {
                                var t = [],
                                    ...
                                    o =
                                        (x.tickSize &&
                                            "quarter" === x.tickSize[1]) ||
                                        (x.minTickSize &&
                                            "quarter" === x.minTickSize[1])
                                            ? w
                                            : y;
                                null != x.minTickSize &&
                                    (n =
                                ...
                                "second" == l
                                    ...
                                    : "year" == l &&
                                      i.setFullYear(v(i.getFullYear(), h)),
                                    i.setMilliseconds(0),
                                    ...
                                    2 * k.month <= u &&
                                        i.setMonth(v(i.getMonth(), 3)),
                                    2 * k.quarter <= u &&
                                        i.setMonth(v(i.getMonth(), 6)),
                            ...
                            (t.tickFormatter = function (e, t) {
                                ...
                                var n =
                                        (t.options.tickSize &&
                                            "quarter" ==
                                                t.options.tickSize[1]) ||
                                        (t.options.minTickSize &&
                                            "quarter" ==
                                                t.options.minTickSize[1]),
